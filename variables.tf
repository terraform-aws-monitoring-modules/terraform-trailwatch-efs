variable "efs_file_system_ids" {
  description = "The list of Elastic File System IDs to monitor."
  type        = list(string)
}

variable "efs_file_system_event_names" {
  description = "The list of event names to monitor for each Elastic File System."
  type        = list(string)
  default     = ["DeleteFileSystem", "UpdateFileSystem", "CreateMountTarget", "DeleteMountTarget"]
}
